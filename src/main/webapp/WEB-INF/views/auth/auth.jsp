		...
		<div class='container' id='container'>
			...
			<div class='form-container register-container'>
				<form id='registerForm' action='/bakery/register/' method='POST'>
					...
					<input id='nameRegister' type='text' placeholder='Your name' name='fullName'>
					<!--  -->
					<input id='usernameRegister' type='text' placeholder='Username' name='username'>
					<!--   -->
					<input id='passwordRegister' type='password' placeholder='Password' name='password'>
					<!--  -->
					<input id='rePasswordRegister' type='password' placeholder='Repeat Password'>
					<button>Register</button>
					<span>or use your account</span>
					<div class='social-container'>
						<a href='#' class='social'><i class='lni lni-facebook-fill'></i></a>
						<a href='#' class='social'><i class='lni lni-google'></i></a> <a href='#' class='social'><i
			...
			<div class='form-container login-container'>
				<form id='loginForm' action='/bakery/j_spring_security_check' method='POST'>
					<h1>Login Cutie Pies</h1>
					<input id='usernameLogin' name='username' type='text' placeholder='Username'>
					<!--  -->
					<input id='passwordLogin' name='password' type='password' placeholder='Password'>
					<!--  -->
					<div class='content'>
						<div class='checkbox'>
							<input type='checkbox' name='checkbox' id='rememberme'> <label for='rememberme'>Remember
								me</label>
						</div>
						<div class='pass-link'>

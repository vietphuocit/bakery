	...
	<%@ include file='/common/taglib.jsp' %>
		...
		<div class='container-xxl flex-grow-1 container-p-y'>
			...
			<div class='card'>
				<div class='card-header d-flex justify-content-between my-table-header align-items-center'>
					...
					<button type='button' class='btn btn-primary h-25 float-right' data-bs-toggle='modal'
						data-bs-target='#addProduct'>Thêm
						mới</button>
				</div>
										...
										<div class='dropdown'>
											...
											<div class='dropdown-menu'>
												<button class='dropdown-item' data-bs-toggle='modal'
													data-bs-target='#editProduct${ product.primaryKeyProduct.id }-${ product.primaryKeyProduct.size }'
													type='button'>
				...
				<div class='modal-content'>
					...
					<div class='row'>
						<div class='col mb-3'>
							<label for='selectCategory' class='form-label'>Danh mục</label> <select
								class='form-select form-select-lg my-input' id='categoryId' name='categoryId'>
					...
					<div class='row'>
						<div class='col mb-3'>
							...
							<textarea form='formAddProduct' id='description' name='description' class='form-control'
		...
		<core:forEach var='product' items='${ products }'>
			<div class='modal fade'
				id='editProduct${ product.primaryKeyProduct.id }-${ product.primaryKeyProduct.size }' tabindex='-1'
				aria-hidden='true'>
				<div class='modal-dialog' role='document'>
					<div class='modal-content'>
						<div class='modal-header'>
							<h5 class='modal-title' id='btnAddCategory'>Chỉnh sửa sản phẩm</h5>
							<button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
						</div>
						...
						<div class='row'>
							<div class='col mb-3 d-none'>
								<label for='size' class='form-label'>Kích thước (cm)</label> <input type='number'
									id='size' name='size' class='form-control' placeholder='Nhập kích thước' value=${
									product.primaryKeyProduct.size } />
							</div>
							<div class='col mb-3'>

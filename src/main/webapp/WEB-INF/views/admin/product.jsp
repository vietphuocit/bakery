								...
								<div class='dropdown'>
									...
									<div class='dropdown-menu'>
										...
										<a class='dropdown-item'
											href='<core:url value='/admin/product/${ product.primaryKeyProduct.id }/${ product.primaryKeyProduct.size }' />'><i
...
<core:forEach var='product' items='${ products }'>
	<div class='modal fade'
		id='editProduct${ product.primaryKeyProduct.id }-${ product.primaryKeyProduct.size }'
				...
				<form id='formProduct' class='modal-body'
					...
					<div class='row'>
						...
						<div class='col mb-3'>
							<label for='discount' class='form-label'>Giảm giá</label> <input
								type='number' id='discount' name='discount' class='form-control'
								placeholder='Nhập số lượng' value='${ product.discount }' />
						</div>
					</div>
					<div class='row'>
						<div class='col mb-3'>

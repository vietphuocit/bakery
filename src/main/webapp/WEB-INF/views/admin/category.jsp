	...
	<div class="card">
		<div
			...
			<button type="button" class="btn btn-primary float-right"
				data-bs-toggle="modal" data-bs-target="#addCategory">Thêm
				mới</button>
		</div>
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu">
										...
										<a class="dropdown-item"
											href='<core:url value="/admin/category/${ category.id }" />'><i
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form class="modal-body"
				action='<core:url value="/admin/category" />' method="POST">
				<div class="row">
					<div class="col mb-3">
						<label for="nameBasic" class="form-label">Tên danh mục</label> <input
	...
	<div class="modal fade" id="editCategory${ category.id }" tabindex="-1"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form class="modal-body"
					action='<core:url value="/admin/category/${ category.id }" />'
					method="POST">
					<div class="row">
						<div class="col mb-3">
							<label for="nameBasic" class="form-label">Tên danh mục</label> <input
								type="text" id="name" name="name" class="form-control"
								placeholder="Nhập tên" value='${ category.name }' />
						</div>
					</div>

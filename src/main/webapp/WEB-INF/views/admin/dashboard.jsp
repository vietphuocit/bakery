				...
				<div class='d-flex align-items-end row'>
					...
					<div class='col-sm-5 text-center text-sm-left'>
						<div class='card-body pb-0 px-0 px-md-4'>
							<img
								src='<core:url value='/template/admin/img/illustrations/man-with-laptop-light.png' />'
						...
						<div class='card-body'>
							<div
								...
								<div class='avatar flex-shrink-0'>
									<img
										src='<core:url value='/template/admin/img/icons/unicons/chart-success.png'/>'
					...
					<div class='card'>
						<div class='card-body'>
							<div
								...
								<div class='avatar flex-shrink-0'>
									<img
										src='<core:url value='/template/admin/img/icons/unicons/wallet-info.png'/>'
							...
							<div class='text-center'>
								<div class='dropdown'>
									...
									<div class='dropdown-menu dropdown-menu-end'
										...
										<a class='dropdown-item' href='javascript:void(0);'>2021</a> <a
											class='dropdown-item' href='javascript:void(0);'>2020</a> <a
											class='dropdown-item' href='javascript:void(0);'>2019</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class='card'>
						<div class='card-body'>
							<div
								...
								<div class='avatar flex-shrink-0'>
									<img
										src='<core:url value='/template/admin/img/icons/unicons/paypal.png'/>'
										alt='Credit Card' class='rounded' />
								</div>
								<div class='dropdown'>
					...
					<div class='card'>
						<div class='card-body'>
							<div
								...
								<div class='avatar flex-shrink-0'>
									<img
										src='<core:url value='/template/admin/img/icons/unicons/cc-primary.png'/>'
										alt='Credit Card' class='rounded' />
								</div>
								<div class='dropdown'>
				...
				<div class='card-body'>
					<ul class='p-0 m-0'>
						...
						<li class='d-flex mb-4 pb-1'>
							<div class='avatar flex-shrink-0 me-3'>
								<img
									src='<core:url value='/template/admin/img/icons/unicons/chart.png'/>'
									alt='User' class='rounded' />
							</div>
							<div
								class='d-flex w-100 flex-wrap align-items-center justify-content-between gap-2'>
						...
						<li class='d-flex mb-4 pb-1'>
							<div class='avatar flex-shrink-0 me-3'>
								<img
									src='<core:url value='/template/admin/img/icons/unicons/cc-success.png'/>'
									alt='User' class='rounded' />
							</div>
							<div
								class='d-flex w-100 flex-wrap align-items-center justify-content-between gap-2'>
						...
						<li class='d-flex'>
							<div class='avatar flex-shrink-0 me-3'>
								<img
									src='<core:url value='/template/admin/img/icons/unicons/cc-warning.png'/>'
									alt='User' class='rounded' />
							</div>
							<div
								class='d-flex w-100 flex-wrap align-items-center justify-content-between gap-2'>

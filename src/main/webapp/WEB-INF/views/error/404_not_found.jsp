...
<!-- Page -->
<link rel="stylesheet"
	href='<core:url value="/template/sneat/assets/vendor/css/pages/page-misc.css" />' />
<!-- Helpers -->
<script
...
<body>
	<div class="container-xxl container-p-y">
		<div class="misc-wrapper">
			...
			<div class="mt-3">
				<img
					src='<core:url value="/template/sneat/assets/img/illustrations/page-misc-error-light.png"/>'

...
<div class="box1">
		...
		<div id="isotope-options">
			<ul id="isotope-filters" class="clearfix">
				<li><a href="/bakery/product" class="selected" data-filter="*"> All</a></li>
		...
		<ul class="thumbnails thumbnails-iisotope" id="isotope-items">
			<c:forEach var="product" items="${filterProduct}">
					...
					<div class="thumb-isotope">
						<div class="thumbnail clearfix">
							<a href="https://via.placeholder.com/946x724">
								<figure>
									<img src="<c:url value = '/${product.imageSource}'/>" alt="">
									<em></em>
								</figure>
				...
				<footer>
					<div class="copyright">
						Copyright © 2020 <a
							href="https://gridgum.com/themes/category/free/">Free

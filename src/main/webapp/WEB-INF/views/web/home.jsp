...
<section class='hero'>
	<div class='hero__slider owl-carousel'>
		<div class='hero__item set-bg'
			data-setbg='<core:url value='/template/assets/img/hero/hero-1.jpg'/>'>
			<div class='container'>
	...
	<div class='container'>
		<div class='row'>
			...
			<div class='col-lg-3 col-md-6 col-sm-6'>
				<div class='product__item'>
					<div class='product__item__pic set-bg'
						data-setbg='<core:url value='/template/assets/img/shop/product-7.jpg'/>'>
						<div class='product__label'>
							<span>Cupcake</span>
						</div>
					</div>
			...
			<div class='col-lg-3 col-md-6 col-sm-6'>
				<div class='product__item'>
					<div class='product__item__pic set-bg'
						data-setbg='<core:url value='/template/assets/img/shop/product-8.jpg'/>'>
						<div class='product__label'>
							<span>Cupcake</span>
						</div>
					</div>
...
<section class='class spad'>
	<div class='container'>
			...
			<div class='col-lg-6'>
				<div class='class__form'>
					<div class='section-title'>
						...
						<h2>
							Made from your <br />own hands
						</h2>
					</div>
					<form action='#'>
						<input type='text' placeholder='Name'> <input type='text'
							placeholder='Phone'> <select>
							<option value=''>Studying Class</option>
							<option value=''>Writting Class</option>
							<option value=''>Reading Class</option>
						</select> <input type='text' placeholder='Type your requirements'>
		...
		<div class='class__video set-bg'
			data-setbg='<core:url value='/template/assets/img/class-video.jpg'/>'>
			<a
		...
		<div class='row'>
			<div class='col-lg-3 col-md-6 col-sm-6'>
				<div class='team__item set-bg'
					data-setbg='<core:url value='/template/assets/img/team/team-1.jpg'/>'>
			...
			<div class='col-lg-3 col-md-6 col-sm-6'>
				<div class='team__item set-bg'
					data-setbg='<core:url value='/template/assets/img/team/team-2.jpg'/>'>
					<div class='team__item__text'>
						<h6>Randy Butler</h6>
						<span>Decorater</span>
						<div class='team__item__social'>
			...
			<div class='col-lg-3 col-md-6 col-sm-6'>
				<div class='team__item set-bg'
					data-setbg='<core:url value='/template/assets/img/team/team-3.jpg'/>'>
					<div class='team__item__text'>
						<h6>Randy Butler</h6>
						<span>Decorater</span>
						<div class='team__item__social'>
			...
			<div class='col-lg-3 col-md-6 col-sm-6'>
				<div class='team__item set-bg'
					data-setbg='<core:url value='/template/assets/img/team/team-4.jpg'/>'>
					<div class='team__item__text'>
						<h6>Randy Butler</h6>
						<span>Decorater</span>
						<div class='team__item__social'>
					...
					<div class='testimonial__item'>
						<div class='testimonial__author'>
							<div class='testimonial__author__pic'>
								<img
									src='<core:url value='/template/assets/img/testimonial/ta-1.jpg'/>'
									alt=''>
							</div>
						...
						<div class='rating'>
							<span class='icon_star'></span> <span class='icon_star'></span> <span
				...
				<div class='row'>
					<div class='col-lg-4 col-md-4 col-sm-4 col-6'>
						<div class='instagram__pic'>
							<img
								src='<core:url value='/template/assets/img/instagram/instagram-1.jpg'/>'
								alt=''>
						</div>
					</div>
					<div class='col-lg-4 col-md-4 col-sm-4 col-6'>
						<div class='instagram__pic middle__pic'>
							<img
								src='<core:url value='/template/assets/img/instagram/instagram-2.jpg'/>'
								alt=''>
						</div>
					</div>
					<div class='col-lg-4 col-md-4 col-sm-4 col-6'>
						<div class='instagram__pic'>
							<img
								src='<core:url value='/template/assets/img/instagram/instagram-3.jpg'/>'
								alt=''>
						</div>
					</div>
					<div class='col-lg-4 col-md-4 col-sm-4 col-6'>
						<div class='instagram__pic'>
							<img
								src='<core:url value='/template/assets/img/instagram/instagram-4.jpg'/>'
								alt=''>
						</div>
					</div>
					<div class='col-lg-4 col-md-4 col-sm-4 col-6'>
						<div class='instagram__pic middle__pic'>
							<img
								src='<core:url value='/template/assets/img/instagram/instagram-5.jpg'/>'
								alt=''>
						</div>
					</div>
					<div class='col-lg-4 col-md-4 col-sm-4 col-6'>

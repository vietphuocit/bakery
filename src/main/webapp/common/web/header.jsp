						...
						<div class='col-lg-12'>
							<div class='header__top__inner'>
								...
								<div class='header__logo'>
									<a href='<core:url value='/'/>'><img src='<core:url value='/template/web/img/logo-header.png'/>'
									alt=''></a>
								</div>
								<div class='header__top__right'>
									<div class='header__top__right__links'>
										<a href='#' class='search-switch'><img src='<core:url value='/template/web/img/icon/search.png'/>'
											alt=''></a> <a href='<core:url value='/wishlist'/>'><img
											src='<core:url value='/template/web/img/icon/heart.png'/>'
										alt=''></a>
									</div>
									<div class='header__top__right__cart'>
										<a href='<core:url value='/cart'/>'><img src='<core:url value='/template/web/img/icon/cart.png'/>'
										alt=''> <span>0</span></a>
